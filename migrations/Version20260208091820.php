 ...
 */
final class Version20260208091820 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task ADD COLUMN deadline DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE task ADD COLUMN priority VARCHAR(20) DEFAULT \'normal\' NOT NULL');
    }
